...
public:
	...
	chip8_emulator () {
        ...
        screen = std::make_unique<monochrome_screen>(screen_width, screen_height, "CHIP Towers");  
        keypad = std::make_unique<chip8_keypad>();      
...
private:
    ...
    std::unique_ptr<monochrome_screen> screen;
    std::unique_ptr<chip8_keypad> keypad;
